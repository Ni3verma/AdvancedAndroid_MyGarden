...
public class PlantWateringService extends IntentService {
    ...
    // TODO (1): Change ACTION_WATER_PLANTS to ACTION_WATER_PLANT and use EXTRA_PLANT_ID to pass the plant ID to the service and update the query to use SINGLE_PLANT_URI
