...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionWaterPlants() {
        ...
        getContentResolver().update(PLANTS_URI, cv, PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME + ">?", new String[]{String.valueOf(timeNow - PlantUtils.MAX_AGE_WITHOUT_WATER)});
    }
}
